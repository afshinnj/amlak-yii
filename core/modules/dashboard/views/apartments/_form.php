            ...
            <div class="col-lg-6">
                ...
                <div class="row"> 
                    ...
                    <div class="col-lg-12">
                        ...
                        <label>
                            ...
                            <input type="radio" value="new" name="Apartments[old_home]" <?php if($model['old_home'] == 'new'){ echo 'checked="checked"';}?>> 
                            <?= Html::activeLabel($model, 'new') ?>
                        </label>

                        <label>
                            <input type="radio" value="old" name="Apartments[old_home]" <?php if($model['old_home'] == 'old'){ echo 'checked="checked"';}?>>
                            <?= Html::activeLabel($model, 'old') ?>
                        </label>

                        <label>
                            <input type="radio" value="restored" name="Apartments[old_home]" <?php if($model['old_home'] == 'restored'){ echo 'checked="checked"';}?>>
                            <?= Html::activeLabel($model, 'restored') ?>
                        </label>

                        <label> 
                            <?php //$form->field($model, 'age', ['template' => '{input}'])->textInput(['maxlength' => 255]) ?>
                            <input type="radio" value="4" name="Apartments[old_home]" <?php if(is_numeric($model['old_home'])){ echo 'checked="checked"';}?>>
                            <input type="text"  name="Apartments[age]" style="padding: 6px 12px; width: 50px; text-align: center; border-color:#d2d6de; border: 1px solid #CCC" <?php if(is_numeric($model['old_home'])){ echo "value =" .$model['old_home'];}?>>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <label>
                            <input type="radio" value="Northern" name="Apartments[location]" <?php if($model['location'] == 'Northern'){ echo 'checked="checked"';}?>>
                            <?= Html::activeLabel($model, 'Northern') ?>
                        </label>

                        <label>
                            <input type="radio" value="Southern" name="Apartments[location]" <?php if($model['location'] == 'Southern'){ echo 'checked="checked"';}?>>
                            <?= Html::activeLabel($model, 'Southern') ?>
                        </label>


                        <label>
                            <input type="radio" value="Eastern" name="Apartments[location]" <?php if($model['location'] == 'Eastern'){ echo 'checked="checked"';}?>>
                            <?= Html::activeLabel($model, 'Eastern') ?>
                        </label>


                        <label> 
                            <input type="radio" value="'Western" name="Apartments[location]" <?php if($model['location'] == 'Western'){ echo 'checked="checked"';}?>>
