...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            [['newPassword'], 'required', 'on' => ['register', 'reset','account']],
            [['newPasswordConfirm'], 'required', 'on' => ['reset','register','account']],
        	...
        	[['check'], 'required','requiredValue' => 1, 'on' => ['register'], 'message' => 'برای ثبت نام باید شرایط را قبول کنید'],
