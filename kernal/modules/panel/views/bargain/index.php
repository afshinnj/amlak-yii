...
$this->title = Yii::t('panel','Bargain Types');
...
<div class="bargain-type-index">
    ...
    <p>
        <?= Html::a(Yii::t('panel',Yii::t('panel','Create Bargain Type')), ['/bargain-create'], ['class' => 'btn btn-success']) ?>
    </p>
  <div class="table-responsive">
		<table class="table table-striped table-bordered">
		<thead>
		<tr>
			<th class="text-right"><?= Yii::t('panel','Bargain Types')?></th>
			<th>&nbsp;</th>
			<th>&nbsp;</th>
		</tr>
		</thead>
