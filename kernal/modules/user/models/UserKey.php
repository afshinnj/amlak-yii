...
class UserKey extends ActiveRecord
{
    ...
    */
    ...
    public static function generate($userId, $type, $expireTime = null)
    {
        ...
        $model->type        = $type;
        $model->create_time = Yii::$app->jdate->date('Y-m-d H:i:s');;
    ...
    {
        $now = Yii::$app->jdate->date('Y-m-d H:i:s');;
        return static::find()
            ->where([
                "user_id"      => $userId,
                "type"         => $type,
    ...
    {
        $this->consume_time = Yii::$app->jdate->date('Y-m-d H:i:s');
        $this->save(false);
        return $this;
    }
    ...
    {
        $this->expire_time = Yii::$app->jdate->date('Y-m-d H:i:s');
        $this->save(false);
        return $this;
    }
}