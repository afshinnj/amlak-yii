...
class DefaultController extends Controller
{
        ...
        return [
            'access' => [
                ...
                'rules' => [
                    ...
                    [
                        'actions' => ['account', 'profile', 'resend-change', 'cancel', 'logout','avatar'],
                        'allow'   => true,
                        'roles'   => ['@'],
                    ],
                    [
	...
	{
		/**
		 * Delete Old Session after 3600 S
		 */
		Yii::$app->session->gcSession(Yii::$app->getModule("user")->gcSession);
	}
    /**
    ...
    public function actionAvatar()
    {
	    ...
	    if (Yii::$app->request->isPost) {
	        ...
	        if ($model->validate()) {   
	        	@unlink(Yii::getAlias('@webroot').'/uploads/avatars/'.$profile->avatar);
    	...
    	// render
    	return $this->render("avatar", ['user' => $profile]);
    }
    ...
    public function actionForgot()
    {
        ...
        // render
        return $this->renderPartial("forgot", [
            "model" => $model,
        ]);
    }
